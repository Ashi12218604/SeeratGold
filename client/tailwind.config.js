  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 8px 32px rgba(27, 67, 50, 0.15)',
      ...
      backgroundImage: {
        'gradient-gold': 'linear-gradient(135deg, #C9A84C 0%, #D4B96A 50%, #E0C972 100%)',
        ...
        'gradient-hero': 'linear-gradient(135deg, rgba(27,67,50,0.9) 0%, rgba(27,67,50,0.6) 100%)',
      },
      animation: {
