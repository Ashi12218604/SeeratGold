...
const stages = [
  {
    ...
    description: 'Seerat Gold directly sources raw spices from their native regions — grown naturally with no pesticides or chemicals for the most authentic flavor.',
  ...
  },
  {
    ...
    description: 'Spices are processed using modern techniques that preserve their aroma, vibrant color, original taste, and incredible medical benefits.',
  ...
  },
  {
    ...
    description: 'Freshness and quality are carefully locked in through hygienic, airtight packaging — with absolutely no preservatives added.',
